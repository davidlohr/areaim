...
The default location for the program is /usr/local/share/reaim. 

The "scripts/aim_*.sh" scripts are run by the re-aim tests. The other 
scripts in this directory are samples of wrapper scripts. 

The location for the configuration files is:  /usr/local/share/reaim/. 
The location for the workfile files is:       /usr/local/share/reaim/. 
The location for the program is:              /usr/local/share/reaim. 
