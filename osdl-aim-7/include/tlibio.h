...
#endif /* linux */
#ifdef hpux
#define LIO_IO_TYPES            00021   /* MARCIA: matched linux ???*/
					/* We support pread should add */
#endif /* hpux */
#ifdef CRAY
...
#endif /* linux */
#ifdef hpux
#define LIO_WAIT_TYPES          00300000 /* Marcia matched linux ??? */
#endif /* hpux */
#ifdef CRAY
...
#endif /* linux */
#ifdef hpux
/* MARCIA: just copied linux ???- all signal wait types */
#define LIO_WAIT_SIGTYPES	(LIO_WAIT_SIGPAUSE)
#endif /* hpux */
#ifdef CRAY
/* all signal wait types */
